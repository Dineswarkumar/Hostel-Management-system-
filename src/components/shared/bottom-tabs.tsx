...
export function BottomTabs() {
  ...
  return (
    <nav className="fixed bottom-4 left-1/2 -translate-x-1/2 z-30 w-[calc(100%-2rem)] max-w-lg md:max-w-xl px-2 py-1.5 liquid-glass md:hidden flex items-center justify-around transition-all duration-300">
      {tabs.map((t) => {
